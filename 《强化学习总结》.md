...
![img](《强化学习总结》图片\练习2_5.png "题目2.5 结果")

### 2.6 乐观初始值
乐观初始值测试结果：
![img](《强化学习总结》图片\2_6_乐观初始值测试.png "乐观初始值")
...
练习2.7证明过程：
![img](《强化学习总结》图片\练习2_7.jpg "题目2.7 结果")
...
![img](《强化学习总结》图片\2_7_UCB尖峰.png "UCB测试")
...
![img]( 《强化学习总结》图片\2_8_梯度赌博机算法.png "梯度赌博机算法与采样平均方法的对比（common为采样平均方法）")
...
![img]( 《强化学习总结》图片\3_1_智能体-环境交互.png "智能体-环境交互")
...
![img](《强化学习总结》图片\3_1_转移图.png "转移图示例——捡易拉罐机器人")
...
![img](《强化学习总结》图片\v_star.png "v*回溯图")
![img](《强化学习总结》图片\q_star.png "q*回溯图")
